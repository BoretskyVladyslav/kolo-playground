...
const rooms = [
    ...
    },
    {
        ...
        image: '/images/room-monsters.jpg'
    },
    {
        id: 4,
        ...
        image: '/images/room-basketball.jpg'
    },
    {
        id: 5,
        title: 'ЛАЗЕРНИЙ ТИР',
                                ...
                                <SwiperSlide key={room.id} className={styles.rooms__slide}>
                                    <div className={styles.rooms__card}>
                                        ...
                                        <div className={styles.rooms__content}>
                                            ...
                                            <button className={styles.rooms__moreBtn}>
                                                ДІЗНАТИСЯ БІЛЬШЕ
                                            </button>
                                        </div>
                                    </div>
