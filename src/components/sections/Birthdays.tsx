...
const steps = [
    ...
    },
    {
        ...
        description: 'Інтерактивна підлога, хованка з монстрами, «Wii інтерактив» – 5 різних локацій, де можна грати, змагатися та ставити власні рекорди'
    },
    {
        id: '03',
        ...
        <section id="birthdays" className={styles.birthdays}> 
            <div className={styles.birthdays__container}>
                <div className={styles.birthdays__header}>
                    ...
                    <span className={styles.birthdays__index}>[5]</span>
                </div>
                    ...
                    <div className={styles.birthdays__sidebar}>
                        ...
                        <Reveal animation="scale" delay={0.4}>
                            <div className={styles.birthdays__starWrapper}>
                                <div className={styles.birthdays__star} />
                            </div>
                        </Reveal>
                    </div>
